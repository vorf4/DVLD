...
namespace Business_Layer
{
    ...
    { 
        ...
        private static string GetClassNameByClassID(int classID)
        {
            return clsLicenseClassTB.GetLicenseClassNameByClassID(classID);
        }
        ...
        {
            return GetClassNameByClassID(classID);
        }
